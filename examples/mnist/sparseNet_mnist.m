function [net, info] = sparseNet_mnist(varargin)
%sparseNet_MNIST  Demonstrates sparse coding networks on MNIST
...
opts.expDir = fullfile(vl_rootnn, 'data', ...
  sprintf('mnist-%s', opts.modelType)) ;
[opts, varargin] = vl_argparse(opts, varargin) ;
...
switch opts.modelType
  case 'sparseNet'
    net = sparseNet_mnist_init('networkType', opts.networkType, 'batchSize', opts.batchSize) ;
  otherwise
